...
public class MainActivity extends AppCompatActivity {
    ...
    private void refreshData() {
        ...
        for(StudentModel studentModel:studentModelList){
            datalist.append("ID : "+studentModel.getId()+" | Name : "+studentModel.getName()+" | Email : "+studentModel.getEmail()+" | DOB : "+studentModel.getDob()+ " | Task : "+studentModel.getTask()+" \n\n");
        }
    }
    ...
    private void showDataDialog(final String id) {
        ...
        task.setText(studentModel.getTask());
        ...
        update_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                studentModel.setTask(task.getText().toString());
