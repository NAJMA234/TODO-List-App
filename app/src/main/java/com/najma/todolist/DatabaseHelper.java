...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void AddStudnet(StudentModel studentModel){
        ...
        contentValues.put(task,studentModel.getTask());
    ...
    public StudentModel getStudent(int id){
        ...
        Cursor cursor=db.query(TABLE_NAME,new String[]{ID,name,email,task,dob,created_at},ID+" = ?",new String[]{String.valueOf(id)},null,null,null);
        if(cursor!=null){
            cursor.moveToFirst();
        }
